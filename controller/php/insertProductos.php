...
class Guardar {
	public function registrar($nombreComercial, $codigoBarra, $codigoReferencia, $observacion, $claveCuadroBasico, $descripcionCuadroBasico, $direccion, $descripcionImagen, $idSalud, $idProveedor, $terminado) {
		...
		$registrar = false;
		$consulta  = "INSERT INTO producto(nomComercial, codigoBarra, codigoReferencia, observacion, claveCuadroBasico, descripcionCuadroBasico,terminado,idSalud)
                    VALUES (:nomComercial, :codigoBarra, :codigoReferencia, :observacion, :claveCuadroBasico, :descripcionCuadroBasico, :terminado, :idSalud)";
		$valores = array(
